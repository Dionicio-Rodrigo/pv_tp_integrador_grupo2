  ...
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      <Paper sx={{ p: 4 }}>
        <Stack spacing={3}>
          <Box>
            <Typography variant="h5" gutterBottom sx={{ color: "colores.oscuro", fontWeight: 700 }}>
          ...
          <Stack direction="row" spacing={2}>
            ...
            <Paper sx={{ p: 3, flex: 1, textAlign: "center" }}>
              <Typography variant="h3" sx={{ color: "primary.main", fontWeight: 700 }}>
              { clientes.map((c) => c.address.city) .filter((ciudad, indice, self) => self.indexOf(ciudad) === indice).length }
              </Typography>
              <Typography variant="body2" sx={{ color: "colores.marron" }}>
                Ciudades
              </Typography>
