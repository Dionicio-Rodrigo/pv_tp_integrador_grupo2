...
const DetalleCliente = () => {
  ...
  if (error || !cliente) return (
    <Container sx={{ mt: 4 }}>
      ...
      <BotonNavegacion variant="contained" onClick={() => navigate("/clientes")} sx={{ mt: 2 }}>
        Regresar al listado
      </BotonNavegacion>
    </Container>
  );
  ...
  const ponerMayuscula = (palabra) => palabra.charAt(0).toUpperCase() + palabra.slice(1);
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 4, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", height: "100%" }}>
            <Typography variant="h5" sx={{ fontWeight: 800, color: "colores.marron", lineHeight: 1.2, mb: 1 }}>
            ...
            <Box sx={{ width: "100%", bgcolor: "colores.crema", p: 2, borderRadius: 2, border: "1px dashed", borderColor: "colores.beige" }}>
              <Typography sx={{ color: "colores.marron", fontWeight: 700, mb: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <Lock sx={{ fontSize: 18, mr: 1 }} /> Acceso al Sistema
              </Typography>
              <Typography variant="body2"><strong>Usuario:</strong> {username}</Typography>
              <Typography variant="body2"><strong>Clave:</strong> {password}</Typography>
            </Box>
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} md={8}>
          <Paper sx={{ p: 4, height: "100%" }}>
            ...
            <Typography variant="h6" sx={{ color: "colores.acento", fontWeight: 700, mb: 2 }}>
              ...
              <Grid item xs={12} sm={6}>
                <Stack spacing={2}>
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Typography><strong>Dirección:</strong> {street} {number}</Typography>
                  </Box>
                  <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <Grid item xs={12} sm={6}>
                <Stack spacing={2}>
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Typography><strong>Codigo Postal:</strong> {zipcode}</Typography>
                  </Box>
                </Stack>
              </Grid>
            </Grid>
